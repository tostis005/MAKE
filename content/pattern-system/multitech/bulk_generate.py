...
def make_catalog_variant(base, suffix, data):
    ...
    if suffix=='CS':
        ...
        p['download']=f'files/Drielo_{code}.pdf'; p['featured_image']=f'assets/{code}-product.webp'; p['gallery']=[]; p['gallery_revision']=20260924
        ...
        p['categories']=cfg['category']; p['download']=f'files/Drielo_{code}.pdf'; p['featured_image']=f'assets/{code}-product.webp'; p['gallery']=[]; p['gallery_revision']=20260924
