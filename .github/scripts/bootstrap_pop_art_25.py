...
def row_for(base,suffix,data):
 ...
 row={'code':code,'sku':f'DRIELO-{code}','base_design_id':base,'design_id':code,'technique_code':suffix,'technique':technique,
      'title':title,'title_en':title,'title_es':title_es_full,'slug':f'{slug}-{technique}-pattern','price':{'CS':2.99,'C2C':2.49,'TC':2.49,'LH':2.49}[suffix],'collection':CID,
