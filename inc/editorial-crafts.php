...
, 'index.php?make_journal=1&make_lang=es&make_craft_slug=$matches[1]&make_craft_section=$matches[2]', 'top' );
    add_rewrite_rule( '^articulos/tecnica/([a-z0-9-]+)/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
    ...
    foreach ( $items as $index => $item ) {
        ...
        if ( '' === $url ) {
            if ( $post_id > 0 ) {
                ...
                $craft = make_current_editorial_craft();
                if ( '' !== $craft ) {
                    $url = make_editorial_craft_url( $craft );
                } elseif ( function_exists( 'make_current_stitch_theme' ) && '' !== make_current_stitch_theme() ) {
                    $url = make_stitch_theme_url( make_current_stitch_theme() );
                } else {
                    $url = make_journal_url();
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=es&make_craft_slug=$matches[1]&make_craft_section=$matches[2]&paged=$matches[3]', 'top' );
    add_rewrite_rule( '^articulos/tecnica/([a-z0-9-]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=es&make_craft_slug=$matches[1]', 'top' );
    add_rewrite_rule( '^articulos/tecnica/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=es&make_craft_slug=$matches[1]&paged=$matches[2]', 'top' );
    add_rewrite_rule( '^en/articles/craft/([a-z0-9-]+)/([a-z0-9-]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=en&make_craft_slug=$matches[1]&make_craft_section=$matches[2]', 'top' );
    add_rewrite_rule( '^en/articles/craft/([a-z0-9-]+)/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=en&make_craft_slug=$matches[1]&make_craft_section=$matches[2]&paged=$matches[3]', 'top' );
    add_rewrite_rule( '^en/articles/craft/([a-z0-9-]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=en&make_craft_slug=$matches[1]', 'top' );
    add_rewrite_rule( '^en/articles/craft/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_editorial_craft_routes', 19 );
...
add_filter( 'wp_robots', 'make_editorial_craft_robots', 25 );
, 'index.php?make_journal=1&make_lang=en&make_craft_slug=$matches[1]&paged=$matches[2]', 'top' );
}
add_action( 'init', 'make_editorial_craft_routes', 19 );
