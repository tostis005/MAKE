...
, 'index.php?post_type=product&make_lang=es&paged=$matches[1]', 'top' );
    add_rewrite_rule( '^en/shop/page/([0-9]+)/?
add_action( 'init', 'make_store_pagination_routes', 19 );
...
add_action( 'template_redirect', 'make_redirect_legacy_store_paths_paginated', 3 );
, 'index.php?post_type=product&make_lang=en&paged=$matches[1]', 'top' );

    add_rewrite_rule( '^tienda/coleccion/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_store_pagination_routes', 19 );
...
add_action( 'template_redirect', 'make_redirect_legacy_store_paths_paginated', 3 );
, 'index.php?make_collection_local=$matches[1]&make_lang=es&paged=$matches[2]', 'top' );
    add_rewrite_rule( '^en/shop/collection/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_store_pagination_routes', 19 );
...
add_action( 'template_redirect', 'make_redirect_legacy_store_paths_paginated', 3 );
, 'index.php?make_collection_local=$matches[1]&make_lang=en&paged=$matches[2]', 'top' );

    add_rewrite_rule( '^tienda/categoria/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_store_pagination_routes', 19 );
...
add_action( 'template_redirect', 'make_redirect_legacy_store_paths_paginated', 3 );
, 'index.php?make_product_cat_local=$matches[1]&make_lang=es&paged=$matches[2]', 'top' );
    add_rewrite_rule( '^en/shop/category/([a-z0-9-]+)/page/([0-9]+)/?
add_action( 'init', 'make_store_pagination_routes', 19 );
...
add_action( 'template_redirect', 'make_redirect_legacy_store_paths_paginated', 3 );
, 'index.php?make_product_cat_local=$matches[1]&make_lang=en&paged=$matches[2]', 'top' );
}
add_action( 'init', 'make_store_pagination_routes', 19 );
